...
function normalizeCanonicalOfferOutput(parsed, input) {
  ...
  const base = {
    offer_idempotency_key:
      typeof parsed.offer_idempotency_key === "string" && parsed.offer_idempotency_key.length
    ...
    discount_type: typeof parsed.discount_type === "string" ? parsed.discount_type : fb.discount_type,
    discount_value: discountValue,
    valid_for_minutes: validMinutes,
    tone_style: typeof parsed.tone_style === "string" ? parsed.tone_style : fb.tone_style,
    ui_layout_variant:
      typeof parsed.ui_layout_variant === "string" ? parsed.ui_layout_variant : fb.ui_layout_variant,
    image_prompt: typeof parsed.image_prompt === "string" ? parsed.image_prompt : fb.image_prompt,
    justification,
